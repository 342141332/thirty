package com.gearbrother.mushroomWar.rpc.channel {
	...
	import com.gearbrother.mushroomWar.rpc.protocol.RpcProtocol;
	
	import flash.utils.Endian;

	[Event(name="data", type="com.gearbrother.mushroomWar.rpc.event.RpcEvent")]
