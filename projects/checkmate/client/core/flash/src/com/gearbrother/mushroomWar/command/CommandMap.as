...
package com.gearbrother.mushroomWar.command {
	...
	public class CommandMap {
		 ...
		 */
		public function CommandMap(eventDispatcher:IEventDispatcher) {
		...
		protected function verifyCommandClass(commandClass:Class):void {
			if (!verifiedCommandClasses[commandClass]) {
				...
				if (!verifiedCommandClasses[commandClass])
					throw new Error("ContextError.E_COMMANDMAP_NOIMPL + ' - ' + commandClass");
			}
		}
