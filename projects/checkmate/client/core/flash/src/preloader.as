package {
	...
	[SWF(backgroundColor = "0x383934", width = "1000", height = "650")]
	public class preloader extends Sprite {
		...
		[Embed(source = "../lib/lib.swf", symbol = "MCLoading")]
		public var MCLoading:Class;

		public var notice:TextField;

		public var waitMovie:DisplayObject;
...
//			Security.allowDomain("*");
		...
		private function __onLibConfComplete(e:Event):void {
			...
			var url:String = appXml.main;
			mainLoader.load(new URLRequest(url) /*, new LoaderContext(false, loaderInfo.applicationDomain)*/);
		...
		private function center(event:Event = null):void {
			waitMovie.x = (stage.stageWidth - waitMovie.width) >> 1;
			waitMovie.y = (stage.stageHeight - waitMovie.height) >> 1;
			notice.x = (stage.stageWidth - notice.width) / 2;
			notice.y = waitMovie.y + waitMovie.height + 30;
		}
