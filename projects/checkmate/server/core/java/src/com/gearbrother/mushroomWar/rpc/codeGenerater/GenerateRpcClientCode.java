package com.gearbrother.mushroomWar.rpc.codeGenerater;
...
public class GenerateRpcClientCode {
	...
	static public final String SCAN_MODEL_PACKAGE = "com.gearbrother.mushroomWar.pojo";
	...
	public static boolean isSubClazz(Class<?> parent, Class<?> sub) {
		try {
			return parent.asSubclass(sub) == null ? false : true;
		} catch (Exception e) {
			return false;
		}
	}
	...
	public static void main(String[] args) throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, ClassNotFoundException, IOException, IntrospectionException, NoSuchFieldException {
		...
		String code =
			"package com.gearbrother.mushroomWar.rpc.protocol.bussiness {\n" +
			"	import com.gearbrother.mushroomWar.rpc.protocol.*;\n" +
			"\n" +
			"	/**\n" +
...
class RpcBeanTemplate {
	...
	public void writeActionScript3RpcService(OutputStream stream) throws UnsupportedEncodingException, IOException {
		...
		writeActionScript3Service(stream, false, "com.gearbrother.mushroomWar.rpc.service.bussiness", Arrays.asList(new String[] {"	import com.gearbrother.mushroomWar.rpc.service.*;\n"}), _source.getSimpleName(), "RpcService", new ArrayList<RpcPropertyTemplate>(), rpcMethods);
	}
	...
	public void writeActionScript3RpcBean(OutputStream stream) throws UnsupportedEncodingException, IOException, ClassNotFoundException, IntrospectionException {
		writeActionScript3(stream, true, "com.gearbrother.mushroomWar.rpc.protocol.bussiness", Arrays.asList(new String[] {"	import com.gearbrother.mushroomWar.rpc.protocol.*;\n"}), _source.getSimpleName() + GenerateRpcClientCode.FILE_NAME_EXTENSION, "RpcProtocol", _properties, Arrays.asList(new RpcBeanMethodTemplate[] {}));
	}
...
//			}
		...
		imports.add("import com.gearbrother.mushroomWar.pojo.*;\n");
		imports.add("import com.gearbrother.mushroomWar.rpc.protocol.RpcProtocol;\n");
		String s = 
				"package com.gearbrother.mushroomWar.rpc.protocol.bussiness;\n" +
				"\n" +
	...
	public Class<?> getInnerType(Type type) {
		if (type instanceof Class) {
			...
			if (rawType instanceof Class
					&& (GenerateRpcClientCode.isSubClazz((Class<?>) rawType, List.class) || GenerateRpcClientCode.isSubClazz((Class<?>) rawType, Set.class)) && ((ParameterizedType) type).getActualTypeArguments().length == 1) {
...
//				throw new Error("unknown type");
			...
			if (GenerateRpcClientCode.isSubClazz((Class<?>) ((ParameterizedType) type).getRawType(), List.class)
					|| GenerateRpcClientCode.isSubClazz((Class<?>) ((ParameterizedType) type).getRawType(), Set.class)) {
				return "Array";
