...
public class TaskForward extends TaskInterval {
	static Logger logger = LoggerFactory.getLogger(TaskForward.class);
	...
	public TaskForward(Battle battle, long executeTime, long interval
