...
package com.riaidea.text
{
	 ...
	 * <listing>
		...
		&lt;/rtf&gt;</listing>
	 */
	[Event(name="appendText", type="com.riaidea.text.RichTextFieldEvent")]
	public class RichTextField extends Sprite
	{
		...
		private function dispatchAppendEvent(oldLength:int) : void
		{
			dispatchEvent(new RichTextFieldEvent(RichTextFieldEvent.APPEND_TEXT, oldLength));
		}
