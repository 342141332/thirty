...
package com.gearbrother.glash.common.utils {
	...
	public class GEventMap {
		 ...
		 * @param priority
		 */
		public function mapListener(dispatcher:IEventDispatcher, type:String, listener:Function, eventClass:Class = null, useCapture:Boolean = false, priority:int = 0):void {
			eventClass ||= Event;
