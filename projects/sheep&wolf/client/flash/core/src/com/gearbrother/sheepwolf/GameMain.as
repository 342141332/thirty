package com.gearbrother.sheepwolf {
	...
	import com.gearbrother.sheepwolf.model.ModelRegister;
	import com.gearbrother.sheepwolf.rpc.channel.RpcSocketChannel;
	import com.gearbrother.sheepwolf.rpc.event.RpcEvent;
	import com.gearbrother.sheepwolf.rpc.service.bussiness.AvatarService;
	import com.gearbrother.sheepwolf.rpc.service.bussiness.BattleService;
	import com.gearbrother.sheepwolf.rpc.service.bussiness.RoomService;
	import com.gearbrother.sheepwolf.rpc.service.bussiness.UserService;
	import com.gearbrother.sheepwolf.view.layer.NoteLayer;
	import com.gearbrother.sheepwolf.view.layer.UiLayer;
	import com.gearbrother.sheepwolf.view.layer.scene.LoginSceneView;
	import com.gearbrother.sheepwolf.view.layer.scene.SceneLayer;
	...
	public class GameMain extends GContainer {
		...
		public function GameMain(config:XML = null) {
			...
			tipLayer.getTipView = function(data:*):DisplayObject {
				/*if (data is BattleSkillProtocol) {
					var tip:StringTip = new StringTip();
					tip.bindData = (data as ToolModel).conf.description;
					return tip;
				} else {
					return null;
				}*/
